...
// A SVG icon component for inputs
...
const GetStarted = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-600 text-white flex items-center justify-center p-4 sm:p-6 lg:p-8">
      <div className="w-full max-w-6xl mx-auto bg-black/30 backdrop-blur-lg rounded-2xl overflow-hidden shadow-2xl flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/2 p-8 sm:p-12">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold mb-4">Create Your Account</h2>
          <p className="text-gray-300 mb-8">Join Jodaem Financial by creating a Personal or Business account for free and unlock a new world of banking.</p>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            ...
            <div className="relative">
              ...
              <input type="text" name="name" placeholder="Full Name" required className="w-full bg-gray-700/50 border border-gray-600 rounded-lg p-3 pl-12 text-white placeholder-gray-400 focus:ring-2 focus:ring-green-500 focus:border-green-500 outline-none transition" onChange={handleChange} />
            </div>
            ...
            <div className="relative">
              ...
              <input type="email" name="email" placeholder="Email Address" required className="w-full bg-gray-700/50 border border-gray-600 rounded-lg p-3 pl-12 text-white placeholder-gray-400 focus:ring-2 focus:ring-green-500 focus:border-green-500 outline-none transition" onChange={handleChange} />
            </div>
            ...
            <p className="text-center text-gray-300 text-sm">By creating an account, you agree to our <a href="#" className="text-green-400 hover:underline">Terms of Service</a>.</p>
          </form>
          
          <div className="text-center mt-6">
            <p className="text-gray-400">Already have an account? <Link to="/login-page" className="text-green-400 font-semibold hover:underline">Sign In</Link></p>
          </div>
        </div>
